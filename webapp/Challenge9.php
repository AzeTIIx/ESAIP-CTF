    ...
    <article class="corpus">
      ...
      <section id="msg">
        ...
        <div class="c-article">
          ...
          <div class="c-low">Monsieur Ripoll est impliqué dans une enquête policière concernant un cambriolage qui a eu lieu dans les locaux de l'école. Soupçonnée par la police, elle souhaite l'interroger rapidement pour résoudre cette affaire.<br><br> Il serait lié à une personne dénomée “Michelle” possédant un chien nommé “Cocacola”. <br><br>Pour commencer le chall, on viendra vous chercher.</div>
        </div>
        <!-- Formulaire du flag -->
        <?php getflag($conn,"paul",$username); ?>
      </section>
    </article>
<footer>
            <section class="ft">
