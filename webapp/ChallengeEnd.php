    ...
    <article class="corpus">
      ...
      <section id="msg">
        ...
        <div class="c-article">
            ...
            <div class="c-info">
              <div class="c-descri">
                <?php
                    ...
                    WHERE `name` ='Merci' AND `user_id`='$user_id';";
                ...
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSdlAvjqHd01UIC5iV1rHuRBn562eo6tuLwVOkMXp9zBYNnWog/viewform?usp=sf_link">Lien du questionnaire</a>
                <div class="c-title">The End</div>
              </div>
          ...
          <div class="c-low">Merci d'avoir participer à la première édition du Hack n FLag, vous pouvez prendre 5 minutes pour répondre à ce questionnaire pour nous aider à nous améliorer si vous le souhaitez !<br></div>
        </div>
        <!-- Formulaire du flag -->
        <?php getflag($conn,"Merci",$username); ?>
      </section>
    </article>
<footer>
            <section class="ft">
