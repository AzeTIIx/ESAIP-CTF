    ...
    <article class="corpus">
      ...
      <section id="msg">
        ...
        <div class="c-article">
          <div class="c-high">
            <div class="c-info">
              <div class="c-descri">
                ...
                <a href="/Challenges/Crypto/crack_zip/Secret.zip" download>
          ...
          <div class="c-low">Des enquêteurs ont récupéré une archive zip suspecte que Matteo a téléchargé sur son ordinateur, à prioris c’est un crack photoshop mais rien n’est sûr.<br></div>
        </div>
        <!-- Formulaire du flag -->
        <?php getflag($conn,"Crack ZIP",$username); ?>
      </section>
    </article>
    <footer>
            <section class="ft">
