    ...
    <article class="corpus">
      ...
      <section id="msg">
        ...
        <div class="c-article">
          <div class="c-high">
            <div class="c-info">
              <div class="c-descri">
                ...
                <a href="/Challenges/OSINT/CBO.jpg" download>
          ...
          <div class="c-low">En fouillant sur internet, la police a découvert une photo postée par M. Ripoll lors de ses dernières vacances. Sur la photo, on pouvait voir un clocher traditionnel typique de la région, avec une vue sur les montagnes en arrière-plan. <br><br>Retrouve le village où est allé Monsieur Ripoll, le flag est au format : <br><br>ESAIP{nomduvillage}
<br></div>
        </div>
        <!-- Formulaire du flag -->
        <?php getflag($conn,"Je me souviens plus",$username); ?>
      </section>
    </article>
    <footer>
            <section class="ft">
