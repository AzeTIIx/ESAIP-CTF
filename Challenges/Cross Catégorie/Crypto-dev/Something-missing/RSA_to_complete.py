...
def isBase64(s):
    """
    If the string is a valid base64 string, then the base64 decoded string will be the same as the
    original string

    :param s: The string to check
    :return: The function isBase64() is returning a boolean value.
    """
